...
class PengaturanPengguna extends CI_Controller {
function __construct(){
	...
	{
		$data['dataNotulen'] = $this->m_pengguna->getPengguna();
	...
	function ubahStatus(){
		...
		if($status=='SA'){
			...
			$query = $this->db->get_where('tbl_pengguna',array('id_pengguna'=>$id))->result_array();
